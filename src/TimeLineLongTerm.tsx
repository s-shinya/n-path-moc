...
const items = [
    {
        id: 1,
        group: 1,
        title: 'アイテム1aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa',
        start_time: moment('2020-12-31 00:00:00').valueOf(),//ライン表示の開始日（画面跨ぐ場合は考慮する）
        end_time: moment('2021-03-10 00:00:00').valueOf(),
        bgColor: "#FEB2B2",
        selectedBgColor: "rgb(255, 193, 7)",
        color: "#63171B",
        start_label:moment('2020-12-31 00:00:00').date(),//ライン上部に表示する日付
        end_label: moment('2021-03-10 00:00:00').date(),
    },
    {
        id: 2,
        group: 2,
        ...
        end_time: moment('2021-10-11 00:00:00').valueOf(),
        bgColor: "#9DECF9",
        selectedBgColor: "rgb(255, 193, 7)",
        color: "#065666",
        start_label: moment('2021-10-10 00:00:00').date(),
    ...
    // },
    {
        id: 3,
        group: 3,
        title: 'アイテム3ああああああああああああ',
        start_time: moment('2021-11-10 00:00:00').valueOf(),
        end_time: moment('2022-01-02 00:00:00').valueOf(),
        bgColor: "#9AE6B4",
        selectedBgColor: "rgb(255, 193, 7)",
        color: "#1C4532",
        start_label: moment('2021-11-10 00:00:00').date(),
        end_label: moment('2022-01-02 00:00:00').date(),
    },
]
const items2 = [
    {
...
export const TimeLineLongTerm: VFC = () => {
    ...
    const [dateRange, setDateRange] = useState<{visibleTimeStart:Moment, visibleTimeEnd:Moment}>({
        ...
        // visibleTimeEnd:moment().startOf("month").add(1, "month") 
        visibleTimeStart:moment().startOf("year"),//1年ごと
        visibleTimeEnd:moment().startOf("year").add(1, "year") 
    });
